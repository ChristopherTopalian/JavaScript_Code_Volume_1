...
/* Topalian_Robot_AI.js */

/* Robot AI - Textbox for Input with Send Button - Random Responses every time to keywords and phrases and variations of keywords and phrases found. Other random response when no keywords are found - and Calculations*/
function()
{
    ...
    /* we make it so that the Enter key on the keyboard will trigger a click on the send button */
